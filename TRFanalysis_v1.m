...
% 
% for i
% indxSpat = find(OstSptMsk==TgSpt(i));


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%% !!!! fs is overwritten here!!!! %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
stim1=resample(speechSpectrogram(1:fs*2.8,:), 256, fs);
factor = 524.288/2^24;
%number of channel
chan = 4;
...
resp = double(epochs_Gd(79:end,:,indx(3)));
...
model = mTRFtrain(stim1,resp*factor,256,1,tmin,tmax,lambda,'method','ridge',...
    'split',5,'zeropad',0);
