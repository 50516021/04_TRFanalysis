%%% mTRF EEG analysis for BDF/EDF/CSV - step 3 %%% 
%%% - artifact remove 2
%%%
%%% required Add-ons
%%% - EEGLAB
...
save(strcat(outfolder, 'step3_epochs_', data_name, '_ICAprocessedAfterRejections.mat'),'epochs','t','comps','chs','fs');
...
MeanEp_af = mean(epochs(1:256*(baselinedur+shorteststs),:,:),3);
