...
filename_pdf = strcat(outfolder_mTRFfig_step6, sprintf('SNR_nonsub_%s', experiment_name), '.pdf');
saveas(gcf, filename_pdf)

%% save SNR data 

filename_data = strcat(outfolder, sprintf('step6_SNR_nonsub_%s', experiment_name), '.mat');
